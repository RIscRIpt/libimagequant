...
function(add_jni_dll target)
    ...
    add_library("${target}_dll" SHARED ${native_src})
    target_include_directories("${target}_dll" SYSTEM PRIVATE ${JNI_INCLUDE_DIRS})
    target_include_directories("${target}_dll" PRIVATE ${CMAKE_SOURCE_DIR})
    target_link_libraries("${target}_dll" imagequant ${JNI_LIBRARIES})
    set_property(SOURCE ${native_src} PROPERTY GENERATED 1)
    add_dependencies("${target}_dll" "${target}")
endfunction()
